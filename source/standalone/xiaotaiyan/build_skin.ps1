param(
    ...
    [string]$Developer = 'Personal non-commercial build',
    [string]$PythonPath = '',
...
$skinWork = Join-Path $workspace ("work\taeyeon\skins\{0}\rebuilt" -f $SkinId)
$skinQa = Join-Path $workspace ("outputs\taeyeon-skins\{0}\qa" -f $SkinId)
$skinOutput = Join-Path $workspace 'outputs\taeyeon-skins'
